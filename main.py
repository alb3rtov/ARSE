...
class MainFrame:
    ...
    def __init__(self, master):
        ...
        self.dropdown_province = ttk.Combobox(master, state="readonly", textvariable=self.province_var, values=self.province_value_list)
        ...
        self.dropdown_town = ttk.Combobox(master, state=tk.DISABLED, textvariable=self.town_var)
